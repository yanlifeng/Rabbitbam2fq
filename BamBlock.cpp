...
static int bgzf_uncompress_daflate(uint8_t *dst, size_t *dlen,
...
static int bgzf_uncompress_z(uint8_t *dst, size_t *dlen,
                             const uint8_t *src, size_t slen,
                             uint32_t expected_crc) {
//    z_stream zs = {
//            .zalloc = NULL,
...
//            .msg = NULL,
//            .next_in = (Bytef *) src,
//            .avail_in = static_cast<uInt>(slen),
//            .next_out = (Bytef *) dst,
//            .avail_out = static_cast<uInt>(*dlen)
//    };
    z_stream zs = {
            .next_in = (Bytef *) src,
            .avail_in = static_cast<uInt>(slen),
...
int block_decode_func(struct bam_block *comp, struct bam_block *un_comp) {
    ...
    int ret = bgzf_uncompress_daflate(un_comp->data, reinterpret_cast<size_t *>(&un_comp->length),
