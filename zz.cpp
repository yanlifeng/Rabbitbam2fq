...
//    cout << id << endl;
    ...
    const char *index_path = "/Users/ylf9811/Desktop/QCQCQC/data/hg19/SRR_sort.bam.bai";
        ...
        while (sam_itr_next(hin, iter, b) >= 0) {
            ...
            if (b->core.flag & 16) {
                for (int i = 0; i < b->core.l_qseq; i++)
                    Buffer[id][pos[id] + b->core.l_qseq - 1 - i] = BaseRever[bam_seqi(seq, i)];
                ...
                for (int i = 0; i < b->core.l_qseq; i++) {
                    Buffer[id][pos[id] + i] = (char) quality[b->core.l_qseq - i - 1] + 33;
                }
                pos[id] += b->core.l_qseq;
            } else {
